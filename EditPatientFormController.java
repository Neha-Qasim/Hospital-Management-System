...
public class EditPatientFormController implements Initializable {
    ...
    public void updateBtn() {
    	if(edit_patientID.getText().isEmpty()||edit_name.getText().isEmpty()||edit_gender.getSelectionModel().getSelectedItem()==null||edit_contactNumber.getText().isEmpty()||edit_address.getText().isEmpty()||edit_status.getSelectionModel().getSelectedItem()==null) {
    		alert.errorMessage("Please fill all blank fields!");
    	}else {
    		String updateData="UPDATE patient SET full_name=?,gender=?,mobile_number=?,address=?,status=?,date_modify=? WHERE patient_id='"+edit_patientID.getText()+"'";
